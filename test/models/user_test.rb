...
class UserTest < ActiveSupport::TestCase
  ...
  def setup
    @user = User.new(username: "michael", email: "michael@example.com",
  ...
  test "email should accept correct format" do
    valid_emails =%w[user@example.com MICHAEL@gmail.com m.first@yahoo.ca john+smith@co.uk.org]
  ...
  test "should reject invalid addresses" do
    invalid_emails = %w[user@xample mike@example,com burton.name@gmail. mb@ford+foo.com]
